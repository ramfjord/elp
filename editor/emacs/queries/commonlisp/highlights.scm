; Common-Lisp tree-sitter highlights for `elp-ts-mode'.
;
; Vendored verbatim from nvim-treesitter, then translated by
; `elp-ts-mode--load-commonlisp-rules' to Emacs face names at
; load time.  The body of this file below the "--- begin upstream
; ---" marker is byte-for-byte upstream; touch only the header.
;
; Upstream: https://github.com/nvim-treesitter/nvim-treesitter
;   path:   runtime/queries/commonlisp/highlights.scm
;   commit: 12e0246e4fc2b75742d98a546216234444fdad28
;
; License: Apache-2.0 (see upstream LICENSE in the same repo).
;
; To refresh: copy the file from the upstream commit of your choice,
; bump the commit hash above, leave everything below untouched.  The
; loader knows how to translate the nvim capture names and lua
; predicates it uses.
;
; --- begin upstream ---
(sym_lit) @variable
