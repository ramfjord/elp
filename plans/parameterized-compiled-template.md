...
A standalone follow-up plan, `free-vars-walker.md`, covers
reintroducing free-variable enumeration as a generic sexp primitive
(not a template feature) for use by callers that want to enumerate
a template's required context keys before rendering.
